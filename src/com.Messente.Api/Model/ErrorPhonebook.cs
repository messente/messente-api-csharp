...
namespace com.Messente.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ErrorPhonebook")]
    public partial class ErrorPhonebook : IValidatableObject
    {
        /// <summary>
        ...
        public ErrorPhonebook(List<ErrorItemPhonebook> errors = default(List<ErrorItemPhonebook>))
        {
            ...
            if (errors == null)
            {
                throw new ArgumentNullException("errors is a required property for ErrorPhonebook and cannot be null");
            }
            this.Errors = errors;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
