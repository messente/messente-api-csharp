...
namespace com.Messente.Api.Model
{
    ...
    public partial class ContactFields :  IEquatable<ContactFields>
    {
        ...
        /// <param name="scheduledDeletionDate">The date on which the contact is going to be deletedbecause it has not belonged to a group for 30 days.</param>
        ...
        /// </summary>
        /// <value>The date on which the contact is going to be deletedbecause it has not belonged to a group for 30 days</value>
