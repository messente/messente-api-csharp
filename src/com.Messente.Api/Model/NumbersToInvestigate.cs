...
namespace com.Messente.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NumbersToInvestigate")]
    public partial class NumbersToInvestigate : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="NumbersToInvestigate" /> class.
        /// </summary>
        /// <param name="numbers">A list of phone numbers. Max 10 numbers per request (required).</param>
        public NumbersToInvestigate(List<string> numbers = default(List<string>))
        {
            // to ensure "numbers" is required (not null)
            if (numbers == null)
            {
                throw new ArgumentNullException("numbers is a required property for NumbersToInvestigate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A list of phone numbers. Max 10 numbers per request</value>
