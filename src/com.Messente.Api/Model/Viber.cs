...
namespace com.Messente.Api.Model
{
    ...
    public partial class Viber : IValidatableObject
    {
        ...
        /// <param name="imageUrl">URL for the embedded image..</param>
        ...
        public Viber(string sender = default(string), int validity = default(int), int ttl = default(int), string text = default(string), string imageUrl = default(string), string buttonUrl = default(string), string buttonText = default(string), ChannelEnum? channel = ChannelEnum.Viber, ViberVideo video = default(ViberVideo), ViberTemplate template = default(ViberTemplate), ViberCarousel carousel = default(ViberCarousel))
        {
            this.Sender = sender;
        ...
        */
        ...
        /// </summary>
        /// <value>URL for the embedded image.</value>
        ...
        public ViberTemplate Template { get; set; }

        /// <summary>
        /// Gets or Sets Carousel
        /// </summary>
        [DataMember(Name = "carousel", EmitDefaultValue = false)]
        public ViberCarousel Carousel { get; set; }
