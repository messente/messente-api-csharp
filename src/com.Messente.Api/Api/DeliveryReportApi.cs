...
namespace com.Messente.Api.Api
{
    ...
    /// </summary>
    public interface IDeliveryReportApiSync : IApiAccessor
    {
        ...
        DeliveryReportResponse RetrieveDeliveryReport(Guid omnimessageId, int operationIndex = 0);
        ...
        ApiResponse<DeliveryReportResponse> RetrieveDeliveryReportWithHttpInfo(Guid omnimessageId, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeliveryReportApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeliveryReportApi : IDeliveryReportApiSync, IDeliveryReportApiAsync
    {
    ...
    public partial class DeliveryReportApi : IDeliveryReportApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DeliveryReportApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DeliveryReportApi(com.Messente.Api.Client.Configuration configuration)
        {
        ...
        public DeliveryReportApi(com.Messente.Api.Client.ISynchronousClient client, com.Messente.Api.Client.IAsynchronousClient asyncClient, com.Messente.Api.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeliveryReportResponse</returns>
        public DeliveryReportResponse RetrieveDeliveryReport(Guid omnimessageId, int operationIndex = 0)
        {
            com.Messente.Api.Client.ApiResponse<DeliveryReportResponse> localVarResponse = RetrieveDeliveryReportWithHttpInfo(omnimessageId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeliveryReportResponse</returns>
        public com.Messente.Api.Client.ApiResponse<DeliveryReportResponse> RetrieveDeliveryReportWithHttpInfo(Guid omnimessageId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DeliveryReportApi.RetrieveDeliveryReport";
            ...
            var localVarResponse = this.Client.Get<DeliveryReportResponse>("/omnimessage/{omnimessageId}/status", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("RetrieveDeliveryReport", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<com.Messente.Api.Client.ApiResponse<DeliveryReportResponse>> RetrieveDeliveryReportWithHttpInfoAsync(Guid omnimessageId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeliveryReportResponse>("/omnimessage/{omnimessageId}/status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
